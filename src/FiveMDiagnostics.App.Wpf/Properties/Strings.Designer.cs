...
public static class Strings
{
    ...
    public static string AutoSessionEnabled => ResourceManager.GetString("AutoSessionEnabled", Culture) ?? "Start and stop the session with FiveM";
    public static string AutoSessionStarted => ResourceManager.GetString("AutoSessionStarted", Culture) ?? "FiveM was found — the session started by itself.";
    public static string AutoSessionStoppedFormat => ResourceManager.GetString("AutoSessionStoppedFormat", Culture) ?? "The game has been closed for {0:F0} minutes. The session is ending by itself and the summaries are written to the journal.";
    public static string AutoSessionStartFailedFormat => ResourceManager.GetString("AutoSessionStartFailedFormat", Culture) ?? "The session could not be started automatically: {0}. Start it with the button.";
    public static string AutoSessionStopFailedFormat => ResourceManager.GetString("AutoSessionStopFailedFormat", Culture) ?? "The session could not be ended automatically: {0}. Stop it with the button.";
    ...
    public static string TrayAutoSessionStopped => ResourceManager.GetString("TrayAutoSessionStopped", Culture) ?? "Session ended — the evening is written to the journal.";
    ...
    public static string SessionIdleAuto => ResourceManager.GetString("SessionIdleAuto", Culture) ?? "Session idle. It starts by itself when FiveM appears.";
    public static string SessionPostGameTail => ResourceManager.GetString("SessionPostGameTail", Culture) ?? "The game closed. Measuring what the card releases.";
